...
then
    ...
    cat $readrunfile | xargs -n 1 /mnt/raid6/jiayingzhu/software/conda/miniconda3/bin/python3 /mnt/raid8/datarepo/software/enaBrowserTools-1.5.4/python3/enaDataGet.py -f $seqformat -as /mnt/raid8/datarepo/software/enaBrowserTools-1.5.4/aspera_settings.ini -d  01_rawdata/
